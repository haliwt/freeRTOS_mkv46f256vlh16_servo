...
/******************************************************************************************************
*	Function Name : vTaskTaskUSART
*	Function : translate and receive data by USART
*	Reference: pvParameters 
*	����ֵ: ��
*   ���ȼ��� 1 ����ֵԽС�����ȼ�Խ��
********************************************************************************************************/
static void vTaskUSART(void *pvParameters)
{
 ...
 // const TickType_t xFrequency = 300;
  ...
  const TickType_t xMaxBlockTime = pdMS_TO_TICKS(200); /* �ȴ�ʱ��200ms */
  /* ��ʼ���ṹ��ָ�� */
	ptMsg = &g_tMsg;
...
static void vTaskBLDC(void *pvParameters)
{
	...
	uint32_t ucConValue,mHoldPos,mCurPosValue;
    ...
    {       
	  ...
	  if(xResult == pdPASS)
		...
		if(sampleMask==100){
			    ...
			    #endif
				if(HALL_PULSE > 0) PRINTF("hall ++: %d\r\n", HALL_PULSE);
				else if(HALL_PULSE == 0) PRINTF("hall is zero 0000000 \r\n");
				if(HALL_PULSE < 0) PRINTF("hall: ------%d\r\n", HALL_PULSE);
		}
				 ...
				 case START_PRES:
		          ...
		          if(start_s == 1)
		          {
    				 ...
    				 xTaskNotify(xHandleTaskBLDC,           /* Who's name handleTask */
    								ucControl,              /* send toulvalue of value */
				  ...
				  else 
				  {
					 ...
					 start_s =0;
					  xTaskNotify(xHandleTaskBLDC,          /* Who's name hanleTask */
									ucControl,              /* send to ulvalue of value */
